...
export const terms = `
Terms & Conditions of Mysterium 
for Clients


Mysterium is a software that enables you (the “Client”) to use the internet connection and resources of our contributors (the “Nodes”) for your private browsing on the Mysterium Platform.
...
These are the Terms and conditions of service (the “T&C”) that you agree to by registering and using the services supported by the “Network Operator”. These terms and conditions constitute an agreement between you and Network Operator and governs your access and use of Mysterium software (the “Software”) and private browsing services maintained by Mysterium (the “Services”). 
...
Please see the detailed technical description of the use of the Services on the website [   ]. 
...
In order to maintain the Services and to ensure the proper functioning of Mysterium, the Network Operator does collect limited personal user information and site performance data (see section “Privacy Policy” for more details).
...
For any questions you may contact us: [email address]
