...
function factory (tequilapi, rendererCommunication, statsCollector, statsEventFactory) {
  Vue.use(Vuex)
  ...
  return new Vuex.Store({
    modules: {
      ...
      connection: connectionFactory(tequilapi, rendererCommunication, statsCollector, statsEventFactory),
      errors,
      terms,
      clientProcess
    },
